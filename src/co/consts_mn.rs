...
impl MB {
	...
	const_val!(ICONWARNING, Self::ICONEXCLAMATION.0);
	const_val!(ICONINFORMATION, 0x00000040);
	const_val!(ICONASTERISK, Self::ICONINFORMATION.0);
	const_val!(ICONQUESTION, 0x00000020);
	const_val!(ICONSTOP, Self::ICONERROR.0);
	const_val!(ICONERROR, 0x00000010);
	const_val!(ICONHAND, Self::ICONERROR.0);

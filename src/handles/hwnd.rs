...
impl HWND {
	...
	pub fn GetNextDlgGroupItem(self,
		hCtl: HWND, bPrevious: bool) -> Result<HWND, co::ERROR>
	{
		match ptr_as_opt(
			unsafe {
	...
	pub fn InvalidateRect(self,
		lpRect: Option<&RECT>, bErase: bool) -> Result<(), co::ERROR>
	{
		match unsafe {

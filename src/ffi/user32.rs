...
extern "system" {
	...
	pub fn CreateAcceleratorTableW(paccel: *mut c_void, cAccel: i32) -> HANDLE;
	...
	pub fn DeleteMenu(hMenu: HANDLE, uPosition: u32, uFlags: u32) -> u32;
	pub fn DestroyAcceleratorTable(hAccel: HANDLE) -> u32;
	pub fn DestroyIcon(hIcon: HANDLE) -> u32;
	pub fn DestroyMenu(hMenu: HANDLE) -> u32;
	pub fn DestroyWindow(hWnd: HANDLE) -> u32;
	pub fn DispatchMessageW(lpMsg: *const c_void) -> isize;
	pub fn EnableMenuItem(hMenu: HANDLE, uIDEnableItem: u32, uEnable: u32) -> i32;
	...
	pub fn GetMenuInfo(hMenu: HANDLE, lpmi: *mut c_void) -> u32;
	...
	pub fn RemoveMenu(hMenu: HANDLE, uPosition: u32, uFlags: u32) -> u32;
